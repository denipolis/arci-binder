...
"}")
        ...
        self.shortcut = QKeySequenceEdit(self.mainWidget)
        self.shortcut.setObjectName(u"shortcut")
        self.shortcut.setGeometry(QRect(540, 430, 91, 21))
        ...
        self.profiileNameLabel = QLabel(self.mainWidget)
        self.profiileNameLabel.setObjectName(u"profiileNameLabel")
        self.profiileNameLabel.setGeometry(QRect(330, 410, 191, 16))
...
"border-radius: 15px;")
        ...
        self.shortcut.raise_()
        self.profileName.raise_()
        self.profiileNameLabel.raise_()
