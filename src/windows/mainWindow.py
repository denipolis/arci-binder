...
"}")
        ...
        self.settingsWidgetBackground = QLabel(self.settingsWidget)
        self.settingsWidgetBackground.setObjectName(u"settingsWidgetBackground")
        self.settingsWidgetBackground.setGeometry(QRect(0, 0, 541, 431))
        self.settingsWidgetBackground.setStyleSheet(u"background-color: #13171c;\n"
"border-top-right-radius: 15px;\n"
"border-bottom-right-radius: 15px;")
        self.updateCheckbox = QCheckBox(self.settingsWidget)
        self.updateCheckbox.setObjectName(u"updateCheckbox")
        self.updateCheckbox.setGeometry(QRect(20, 120, 511, 21))
        self.updateCheckbox.setFont(font)
        self.settingsWidgetBackground.raise_()
        self.settingsTitle.raise_()
        self.trayCheckbox.raise_()
        self.autorunCheckbox.raise_()
        self.nameCheckbox.raise_()
        self.updateCheckbox.raise_()
        ...
        icon = QIcon()
        icon.addFile(u":/icons/images/plus-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/images/trash.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.profilesWidgetBackground = QLabel(self.profilesWidget)
        self.profilesWidgetBackground.setObjectName(u"profilesWidgetBackground")
        self.profilesWidgetBackground.setGeometry(QRect(0, 0, 541, 431))
        self.profilesWidgetBackground.setStyleSheet(u"background-color: #13171c;\n"
"border-top-right-radius: 15px;\n"
"border-bottom-right-radius: 15px;")
        self.profilesWidgetBackground.raise_()
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/minimize-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/command.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profilesButton.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/images/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.adButton.setStyleSheet(u"background-color: transparent;")
        icon6 = QIcon()
        icon6.addFile(u":/icons/images/github.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.adButton.setIcon(icon6)
        ...
        self.navigationWidgetBackground = QLabel(self.navigationWidget)
        self.navigationWidgetBackground.setObjectName(u"navigationWidgetBackground")
        self.navigationWidgetBackground.setGeometry(QRect(0, 0, 61, 431))
        self.navigationWidgetBackground.setAutoFillBackground(False)
        self.navigationWidgetBackground.setStyleSheet(u"background-color: #13171c;\n"
"border-top-left-radius: 15px;\n"
"border-bottom-left-radius: 15px;")
        self.navigationWidgetBackground.raise_()
        self.profilesButton.raise_()
        self.settingsButton.raise_()
        self.adButton.raise_()
        self.title.raise_()
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/images/x.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"ArciBinder", None))
        ...
        self.settingsWidgetBackground.setText("")
#if QT_CONFIG(tooltip)
        self.updateCheckbox.setToolTip(QCoreApplication.translate("MainWindow", u"\u041d\u0443\u0436\u043d\u043e, \u0435\u0441\u043b\u0438 \u0432\u044b \u0445\u043e\u0442\u0438\u0442\u0435 \u0447\u0442\u043e \u0431\u044b \u0431\u0438\u043d\u0434\u0435\u0440 \u0440\u0430\u0431\u043e\u0442\u0430\u043b \u0442\u043e\u043b\u044c\u043a\u043e \u0432 \u0438\u0433\u0440\u0435. \u041d\u0435 \u0440\u0430\u0431\u043e\u0442\u0430\u0435\u0442, \u0435\u0441\u043b\u0438 \u0438\u0433\u0440\u0430 \u0437\u0430\u043f\u0443\u0449\u0435\u043d\u0430 \u0432 \u043e\u043a\u043d\u0435.", None))
#endif // QT_CONFIG(tooltip)
        self.updateCheckbox.setText(QCoreApplication.translate("MainWindow", u"\u041d\u0435 \u043f\u0440\u043e\u0432\u0435\u0440\u044f\u0442\u044c \u043d\u0430 \u043d\u0430\u043b\u0438\u0447\u0438\u0435 \u043d\u043e\u0432\u044b\u0445 \u043e\u0431\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0439 \u043f\u0440\u0438 \u0437\u0430\u043f\u0443\u0441\u043a\u0435", None))
#if QT_CONFIG(tooltip)
        ...
        self.profilesWidgetBackground.setText("")
        ...
        self.title.setText("")
        self.navigationWidgetBackground.setText("")
