...
"}")
        ...
        self.nameCheckbox = QtWidgets.QCheckBox(self.settingsWidget)
        self.nameCheckbox.setGeometry(QtCore.QRect(10, 90, 511, 21))
        font = QtGui.QFont()
        font.setFamily("Rubik")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nameCheckbox.setText(_translate("MainWindow", "Использовать бинды не только в RAGE Multiplayer"))
