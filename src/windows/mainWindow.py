...
"}")
        ...
        self.trayCheckbox.setGeometry(QRect(10, 60, 511, 21))
        ...
        self.autorunCheckbox.setGeometry(QRect(10, 80, 511, 21))
        ...
        self.nameCheckbox.setGeometry(QRect(10, 100, 511, 21))
...
"border-bottom-right-radius: 15px;")
        ...
        self.updateCheckbox.setGeometry(QRect(10, 120, 511, 21))
        self.updateCheckbox.setFont(font)
        self.reloadBinderButton = QPushButton(self.settingsWidget)
        self.reloadBinderButton.setObjectName(u"reloadBinderButton")
        self.reloadBinderButton.setGeometry(QRect(10, 150, 381, 41))
        icon = QIcon()
        icon.addFile(u":/icons/images/refresh-ccw.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.reloadBinderButton.setIcon(icon)
        self.reloadBinderButton.setIconSize(QSize(24, 24))
        self.exportProfilesButton = QPushButton(self.settingsWidget)
        self.exportProfilesButton.setObjectName(u"exportProfilesButton")
        self.exportProfilesButton.setGeometry(QRect(10, 200, 381, 41))
        icon1 = QIcon()
        icon1.addFile(u":/icons/images/upload.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.exportProfilesButton.setIcon(icon1)
        self.exportProfilesButton.setIconSize(QSize(24, 24))
        ...
        self.reloadBinderButton.raise_()
        self.exportProfilesButton.raise_()
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/images/plus-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.createProfileButton.setIcon(icon2)
        ...
        self.editProfileButton.setGeometry(QRect(470, 220, 60, 60))
        self.editProfileButton.setFont(font)
        self.editProfileButton.setStyleSheet(u"")
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.editProfileButton.setIcon(icon3)
        ...
        self.deleteProfileButton.setGeometry(QRect(470, 290, 60, 60))
        self.deleteProfileButton.setFont(font)
        self.deleteProfileButton.setStyleSheet(u"")
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/trash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.deleteProfileButton.setIcon(icon4)
...
"border-top-right-radius: 15px;\n"
"border-bottom-right-radius: 15px;")
        self.loadProfileButton = QPushButton(self.profilesWidget)
        self.loadProfileButton.setObjectName(u"loadProfileButton")
        self.loadProfileButton.setEnabled(True)
        self.loadProfileButton.setGeometry(QRect(470, 150, 60, 60))
        self.loadProfileButton.setFont(font)
        self.loadProfileButton.setStyleSheet(u"")
        self.loadProfileButton.setIcon(icon1)
        self.loadProfileButton.setIconSize(QSize(32, 32))
        self.profilesWidgetBackground.raise_()
        self.listWidget.raise_()
        self.deleteProfileButton.raise_()
        self.createProfileButton.raise_()
        self.loadProfileButton.raise_()
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/images/minimize-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/images/command.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profilesButton.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/images/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/images/github.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.adButton.setIcon(icon8)
...
"border-bottom-left-radius: 15px;")
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/images/x.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.reloadBinderButton.setText(QCoreApplication.translate("MainWindow", u" \u041f\u0435\u0440\u0435\u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c \u043e\u0431\u0440\u0430\u0431\u043e\u0442\u0447\u0438\u043a \u043a\u043b\u0430\u0432\u0438\u0448", None))
        self.exportProfilesButton.setText(QCoreApplication.translate("MainWindow", u" \u042d\u043a\u0441\u043f\u043e\u0440\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0432\u0441\u0435 \u043f\u0440\u043e\u0444\u0438\u043b\u0438 \u0432 .abp \u0444\u0430\u0439\u043b\u044b", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.loadProfileButton.setToolTip(QCoreApplication.translate("MainWindow", u"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c \u043f\u0440\u043e\u0444\u0438\u043b\u044c \u0438\u0437 \u0444\u0430\u0439\u043b\u0430 .abp (ArciBinder Profile)", None))
#endif // QT_CONFIG(tooltip)
