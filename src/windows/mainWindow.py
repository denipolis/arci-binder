...
"}")
        ...
        icon = QIcon()
        icon.addFile(u":/icons/images/command.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.profilesButton.setIcon(icon)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/images/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/images/github.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.adButton.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/plus-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.createProfileButton.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/edit.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.editProfileButton.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/images/trash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.deleteProfileButton.setIcon(icon5)
